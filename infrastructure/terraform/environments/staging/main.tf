...
locals {
  ...
  cloud_run_defaults = {
    ...
    dispatch_service = {
      ...
      env_overrides = {
        ENVIRONMENT                            = var.environment_name
        CORS_ORIGINS                           = join(",", var.dispatch_service_cors_origins)
        FIRESTORE_PROJECT_ID                   = var.project_id
        REQUIRE_AUTH                           = "true"
...
module "onboarding_service" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/onboarding-service:latest"
...
module "admin_service" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/admin-service:latest"
...
module "agent_customization_service" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/agent-customization-service:latest"
...
module "agent_webhooks" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/agent-webhooks:latest"
...
module "channel_gateway" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/channel-gateway:latest"
...
module "channel_comms" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/channel-comms:latest"
...
module "notification_service" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/notification-service:latest"
  ...
  env_vars = merge({
    ...
    EVENTS_OIDC_ALLOWED_EMAILS      = module.orders_events_push_sa.email
...
module "payments_service" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/payments-service:latest"
...
module "customer_profile" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/customer-profile-service:latest"
...
module "recommendation" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/recommendation-service:latest"
...
module "wait_time_service" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/wait-time-service:latest"
  ...
  depends_on = [module.wait_time_service_sa]
}
...
module "typesense_indexer" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/typesense-indexer:latest"
  ...
  depends_on = [module.typesense_indexer_sa]
}
...
module "dispatch_service" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/dispatch-service:latest"
...
module "delivery_service" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/delivery-service:latest"
...
module "agent_tools" {
  ...
  image                 = "us-central1-docker.pkg.dev/${local.image_registry_project}/services/agent-tools:latest"
...
module "order_service_waf" {
  ...
  description = "Baseline Cloud Armor policy for staging order service."
